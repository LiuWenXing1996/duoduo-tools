...
export const weightTransferMap: Record<WeightType, WeightTransfer> = {
  ...
  g: {
    ...
    formT: (val) => val * 1_000_000,
    display: (val) => `${val} 克`,
  },
  mg: {
    label: "毫克(mg)",
    toT: (val) => val / 1_000_000_000,
    formT: (val) => val * 1_000_000_000,
    display: (val) => `${val} 毫克`,
  },
  jin: {
    label: "斤(jin)",
  ...
  eng_lb: {
    label: "磅(lb)",
    toT: (val) => val / 2204.62,
    formT: (val) => val * 2204.62,
    display: (val) => `${val} 磅`,
  },
  eng_oz: {
    label: "盎司(oz)",
    toT: (val) => val / 35273.96,
    formT: (val) => val * 35273.96,
    display: (val) => `${val} 盎司`,
  },
  eng_st: {
    label: "英石(st)",
    toT: (val) => val / 157.47,
    formT: (val) => val * 157.47,
    display: (val) => `${val} 英石`,
  },
  eng_cwt: {
    label: "英担(cwt)",
    toT: (val) => val / 19.684,
    formT: (val) => val * 19.684,
    display: (val) => `${val} 英担`,
  },
  eng_dr: {
    label: "打兰(dr)",
    toT: (val) => val / 564383.39,
    formT: (val) => val * 564383.39,
    display: (val) => `${val} 打兰`,
  },
  eng_gr: {
    label: "格令(gr)",
    toT: (val) => val / 15432358.35,
    formT: (val) => val * 15432358.35,
    display: (val) => `${val} 格令`,
  },
  eng_lt: {
    label: "长吨(lt)",
    toT: (val) => val / 0.984143,
    formT: (val) => val * 0.984143,
    display: (val) => `${val} 长吨`,
  },
  eng_lbt: {
    label: "磅(lbt)",
    toT: (val) => val / 2679.23,
    formT: (val) => val * 2679.23,
    display: (val) => `${val} 磅`,
  },
  eng_ozt: {
    label: "盎司(ozt)",
    toT: (val) => val / 32150.75,
    formT: (val) => val * 32150.75,
    display: (val) => `${val} 盎司`,
  },
  eng_grain: {
    label: "格令(grain)",
